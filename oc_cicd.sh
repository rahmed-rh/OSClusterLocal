...
createNexusPVC
oc new-app sonatype/nexus3 --name=nexus3 -n cicd1
...
oc new-app jenkins-persistent --param MEMORY_LIMIT=1Gi --param VOLUME_CAPACITY=5Gi --param JENKINS_PASSWORD=admin123 -n cicd
